##  코인 리스트 애플리케이션 기술 요약 및 설계 정리

제공해주신 프로젝트의 기술 스택, 아키텍처, 그리고 주요 구현 내용을 바탕으로 핵심 사항을 명료하게 정리했습니다.
...
- **Repository (데이터 접근 추상화):** 외부 API 통신(CoinGecko) 및 **DTO를 도메인 엔티티/모델로 변환(매핑)**하는 데이터 어댑터 역할을 수행하며, DIP(의존성 역전 원칙)를 준수합니다.
