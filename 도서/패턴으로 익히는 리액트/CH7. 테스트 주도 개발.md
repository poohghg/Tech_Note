...
![Pasted image 20250911204041.png](../../img/Pasted%20image%2020250911204041.png)
...
![Pasted image 20250911205934.png](../../img/Pasted%20image%2020250911205934.png)
...
> 
> 컴포넌트가 너무 크다면 큰 단위의 컴포넌트에서 점점 작은 컴포넌트를 분리, 세분화하여 구현 한다. 당장 세세한 부분까지 잘 설계된 작은 컴포넌트가 없더라도 항상 잘 동작하는 소프트웨어가 된다.즉, 언제든 작업이 중단되더라도 항상 기능의 동작을 보장한다.
