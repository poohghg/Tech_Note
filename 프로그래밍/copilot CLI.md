...
> 스킬은 폴더에 참조 파일, 템플릿 및 스크립트를 묶어서 저장할 수 있으므로 단일 파일보다 AI에 더 풍부한 컨텍스트를 제공합니다. 기존 프롬프트 형식과 달리 에이전트는 스킬을 자동으로 검색하고 호출할 수 있습니다.

**사용 시점** : 테스트 생성, 문서 작성, 패턴 리팩토링 등 팀에서 정기적으로 수행하는 반복적인 작업에 사용합니다.
