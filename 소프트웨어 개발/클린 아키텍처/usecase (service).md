...
> 여러 엔티티를 조합하여 시스템 단위의 행동을 정의한다.
> 비즈니스 흐름의 순서를 보장한다.
> 도메인 규칙 보장

> 프론트엔드에서 하나의 유저 액션은 하나의 유즈케이스로 매핑된다.
> 유즈케이스는 사용자의 의도를 반영하여 시스템이 어떻게 동작해야 하는지를 정의한다.
> 
> 예)
> - 회원가입
> - 결제 요청
> - 게시글 작성
>   
>   Hooks/UI는 Service를 직접 호출하지 않는다.
>   Use Case 인터페이스를 통해 호출한다.
