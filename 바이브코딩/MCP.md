...
모델 컨테스트 프로토콜(MCP)은 AI에이전트를 외부 데이터 소스 및 도구에 연결하기 위한 개발형 표준이다.
...
+----------------------------------------------------------+
|                    Host (호스트)                           |
|  Claude Desktop, VS Code, Cursor 등의 애플리케이션        |
|                                                          |
|  +-------------------+    +-------------------+          |
...
> AI 모델 과 외부 데이터 원본(또는 도구)이 서로 안전하고 규격화된 방식으로 대화하기 위한 범용 인터페이스 표준이다.
